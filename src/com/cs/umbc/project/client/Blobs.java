...
import com.cs.umbc.project.client.widges.DeleteWidget;
import com.cs.umbc.project.client.widges.SelectWidget;
...
public class Blobs extends Composite {
	...
	private void process(BlobData[] blobData) {
		...
		for (int i = 0; i < blobData.length; i++) {
			...
			String link = "<a target=\"_blank\" href=\"/serve?blob-key=" + blobData[i].getKey() + "\">"
					+ blobData[i].getFilename() + "</a>";
